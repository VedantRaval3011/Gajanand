...
export default function ResetCredentials() {
  ...
  return (
    <div className={`${ubuntu.className} antialiased min-h-screen flex items-center justify-center  bg-gradient-to-r from-amber-500 to-orange-500`}>
      <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
        <h1 className="text-3xl font-bold text-center mb-6 text-gray-800">Reset Credentials</h1>
        ...
        <form onSubmit={resetCredentials}>
          <div className="mb-4">
            <label htmlFor="email-otp" className="block text-lg font-medium text-gray-700 mb-1">
              Email OTP
            </label>
            <input
              id="email-otp"
